...
\fancyhead[L]{National Taiwan University LohneYB}
\fancyhead[R]{\thepage}
...
\lstinputlisting{basic/random_int.cpp}
...
\lstinputlisting{bitwise_trick/builtin_function.cpp}

\subsection{Subset Enumeration}
\lstinputlisting{bitwise_trick/subset_enumeration.cpp}

\subsection{Next Permutation on Binary}
\lstinputlisting{bitwise_trick/next_perm.cpp}

\subsection{SOS DP}
\lstinputlisting{bitwise_trick/SOS_DP.cpp}
...
\lstinputlisting{flow/ISAP(bounded).cpp}
...
\lstinputlisting{graph/Zhu_Liu.cpp}
...
\lstinputlisting{math/fast_power.cpp}
...
\lstinputlisting{math/subset_convolution.cpp}
...
\lstinputlisting{boook/Rotating_Sweep_Line.cpp}
